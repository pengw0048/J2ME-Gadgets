...
public class Jq extends Canvas
{
	...
	public Jq(BTPack btpack, boolean flag, int i, boolean flag1)
	{
		ml = 25;
		ol = 25;
		yet = 5;
	...
	public void keyPressed(int i)
	{
		...
		} else
		{
			...
			if (i == 8)
				if (!got)
				{
					if (map[cx][cy] < 0 || ready && cx == sx && cy == sy)
						return;
					if (ready && map[cx][cy] > 9)
						return;
					if (map[cx][cy] == 12 || map[cx][cy] < 0 || ready && cx == sx && cy == sy)
						return;
					got = true;
					if (ready)
					{
